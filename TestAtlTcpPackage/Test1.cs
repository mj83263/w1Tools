...
namespace TestAtlTcpPackage
{
    ...
    public sealed class Test1
    {
        ...
        public void Init()
        {
            ...
            Encoding gb2312 = Encoding.GetEncoding(936); // 或 "GB2312"
        }
        [TestMethod]
        ...
        public void TestMethod3()
        {
            ...
            var sss = System.Text.Encoding.ASCII.GetString(kk);
        ...
        [TestMethod]
        public void TestEncodeing()
        {
            var tmp = new { a = "abc", b = "测试字符串" };
            var bytes = Encoding.ASCII.GetBytes(JsonConvert.SerializeObject(tmp));
            var bytes2 = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(tmp));
            var kk1 = System.Text.Encoding.ASCII.GetString(bytes);
            var kk2=System.Text.Encoding.UTF8.GetString(bytes2);
            Console.WriteLine("");
        }
